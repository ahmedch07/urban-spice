...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("bg-slate-950 text-slate-400 uppercase font-semibold border-b border-slate-800", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-slate-800 bg-slate-950 font-medium text-slate-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "p-3.5 text-left align-middle font-semibold text-slate-400 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
