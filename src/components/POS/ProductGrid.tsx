      ...
      <div>
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search items by name or SKU... (Press F2)"
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-950/80 font-medium mt-0.5">
              Configure Flavors (Urban Special, Malai Boti, Peri Peri), Sizes, Crusts & Extra Toppings
            </p>
          </div>
        </div>
